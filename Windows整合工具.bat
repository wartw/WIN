...
ECHO    # 14．關閉使用者帳戶控制(UAC)     # 40．關機時強制關閉背景程式不等待   #
ECHO    # 30．Windows To Go啟用應用商店   # 41．關閉不必要的視覺動畫效果       #
...
ECHO    # 14．關閉使用者帳戶控制(UAC)     # 39．關閉 SmartScreen 篩選工具     #
